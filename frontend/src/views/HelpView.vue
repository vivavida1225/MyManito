...
const participantQuizGuides = [
  {
    ...
    description: "내 차례가 열리면 알림과 비밀 퀴즈 메뉴에서 해야 할 일과 마감 시각을 확인할 수 있어요.",
  },
  {
    title: "나에 관한 기준 답안 확정하기",
    description: "첫 단계에서는 나에 관한 질문에 기준 답안을 입력해요. 답안을 확정하지 않으면 해당 문제는 풀이로 이어지지 않으니 꼭 확정해 주세요!",
  },
  {
    title: "내가 챙겨줄 사람의 문제 풀기",
    description: "풀이기간에는 내가 챙겨줄 사람의 질문에 답하고 저장할 수 있어요. 마감 시 마지막으로 저장한 답안이 자동 제출돼요.",
  },
  {
    title: "마니또의 답안 평가하기",
    description: "풀이가 제출되면 내 기준 답안과 마니또의 풀이를 비교해 1~5점을 저장해요.",
  },
  {
    title: "결과와 익명성 확인하기",
    description: "정산된 뒤에는 내가 풀었던 문제의 기준 답안과 회차 결과를 볼 수 있어요.",
  },
];
...
const adminQuizGuides = [
  {
    title: "퀴즈 모드 켜기",
    description: "모든 참가자가 본인 확인을 마치면 관리자 퀴즈 설정에서 모드를 켤 수 있어요.",
  },
  {
    title: "기간과 다음 질문 설정하기",
    description: "다음 공통 질문을 입력하면 다음 회차에 한 번 사용되고, 비워 두면 참가자별로 이전에 받지 않은 시스템 질문이 무작위 배정돼요.",
  },
  {
    title: "익명 진행 현황과 재알림",
    description: "‘미완료자에게 재알림’을 누르면 현재 단계의 대상자에게 퀴즈 관련 알림을 보낼 수 있어요.",
  },
  {
    title: "종료 예정일 충돌 처리하기",
    description: "종료 예정일이 퀴즈 일정과 겹치면 입력기간 중에는 해당 회차를 진행하거나 취소하도록 안내돼요.",
  },
  {
    title: "퀴즈 OFF와 팀 조기 종료",
    description: "퀴즈 모드를 꺼도 이미 시작한 회차는 마감에 따라 정산되고 다음 회차 예약만 사라져요. 사용할 시스템 질문이 부족해지면 모드가 자동으로 꺼지고 관리자에게 알려 드려요.",
  },
];
</script>
