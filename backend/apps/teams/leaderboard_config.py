...
CHAT_LIKE_POINTS = 5
SERVICE_ACCESS_POINTS = 1

CARED_FOR_TO_MANITO_LIKE_MULTIPLIER = 3

CHAT_MESSAGE_COOLDOWN_MINUTES = 30
CHAT_MESSAGE_DAILY_LIMIT = 15
CHAT_LIKE_COOLDOWN_HOURS = 3
SERVICE_ACCESS_COOLDOWN_HOURS = 3
LEADERBOARD_SNAPSHOT_INTERVAL_HOURS = 3
